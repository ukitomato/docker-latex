...
\section{Commands}
\begin{itemize}
  \item TODO.\TODO{You have to do this.}
  \item \CHECK{CHECK.}{You have to check this.}
  \item \FIXME{FIXME.}{You have to fix this.}
  \item \FIXED{Hallo.}{Hello.}
\end{itemize}
